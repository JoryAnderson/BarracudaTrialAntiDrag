...
import com.arcaeic.osrs.BarracudaTrialHelmLock.BarracudaTrialHelmLockPlugin;
 ...
 * instead of the {@link BarracudaTrialHelmLockPlugin} class handling everything.
 */
@Slf4j
@Singleton
...
public class ComponentManager
{
	...
	{
		if (!BarracudaTrialHelmLockConfig.CONFIG_GROUP.equals(e.getGroup()))
		{
			return;
		}

		revalidateComponentStates(e);
	}

	private void revalidateComponentStates(ConfigChanged e)
	{
		components.forEach(c -> c.onConfigChanged(e));
		revalidateComponentStates();
	}
